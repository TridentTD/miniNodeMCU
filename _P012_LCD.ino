    ...
    case PLUGIN_WEBFORM_LOAD:
      {
        ...
        optionValues2[0] = 1;
        optionValues2[1] = 2;
        string += F("<TR><TD>เธซเธ�เน�เธฒเธ�เธญ:<TD><select name='plugin_012_size'>");
        for (byte x = 0; x < 2; x++)
        {
          string += F("<option value='");
        ...
        {
          string += F("<TR><TD>เธ�เธฃเธฃเธ—เธฑเธ”เธ—เธตเน� ");
          string += varNr + 1;
        ...
        string += F("<TR><TD>เธ�เธธเน�เธกเน€เธ�เธดเธ”เน�เธ�เธ�เธทเน�เธ�เธซเธฅเธฑเธ�:<TD>");
        addPinSelect(false, string, "taskdevicepin3", Settings.TaskDevicePin3[event->TaskIndex]);

        char tmpString[128];

        sprintf_P(tmpString, PSTR("<TR><TD>เธ”เธฑเธ�เน�เธ�เธ�เธทเน�เธ�เธซเธฅเธฑเธ�:<TD><input type='text' name='plugin_12_timer' value='%u'> เธงเธดเธ�เธฒเธ—เธต"), Settings.TaskDevicePluginConfig[event->TaskIndex][2]);
        string += tmpString;
