    ...
    case PLUGIN_WEBFORM_LOAD:
      {
        ...
        sprintf_P(tmpString, PSTR("<TR><TD>เธ”เธฑเธ�เน�เธ�เธ�เธทเน�เธ�เธซเธฅเธฑเธ�:<TD><input type='text' name='plugin_23_timer' value='%u'> เธงเธดเธ�เธฒเธ—เธต"), Settings.TaskDevicePluginConfig[event->TaskIndex][2]);
        string += tmpString;
