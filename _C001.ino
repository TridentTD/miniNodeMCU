//#######################################################################################################
//########################### Controller Plugin 001: CloudMQTT #######################################
//#######################################################################################################

#define CPLUGIN_001
#define CPLUGIN_ID_001         1
#define CPLUGIN_NAME_001       "CloudMQTT"
...
boolean CPlugin_001(byte function, struct EventStruct *event, String& string)
{
  ...
  switch (function)
  {
    case CPLUGIN_PROTOCOL_ADD:
      {
        ...
        Protocol[protocolCount].defaultPort = 10000;
        break;
      }
    ...
    case CPLUGIN_PROTOCOL_TEMPLATE:
      {
        strcpy_P(Settings.MQTTsubscribe, PSTR("/%nodename%/#"));
        strcpy_P(Settings.MQTTpublish, PSTR("/%nodename%/%devicename%/%valname%"));
        break;
      }
    ...
    case CPLUGIN_PROTOCOL_SEND:
      {
        ...
        pubname.replace("%devicename%", ExtraTaskSettings.TaskDeviceName);
